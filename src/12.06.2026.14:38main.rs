...
fn show_group_preview(
    ...
    let group_paths: std::rc::Rc<Vec<String>> = std::rc::Rc::new(
    ...
    for (entry_idx, (path, is_ref)) in entries.iter().enumerate() {
        ...
        pic_frame.set_size_request(400, 320);

        let picture = gtk4::Picture::new();
        picture.set_size_request(400, 320);
        ...
        status_overlay_box.set_size_request(400, 320);
        ...
        status_overlay_label.set_max_width_chars(40);
        ...
        moved_to_label.set_max_width_chars(40);
        ...
        let zoom_btn = btn_icon_text("Zoom", "view-fullscreen-symbolic");
...
fn show_zoom_window(parent: &gtk4::Window, paths: &std::rc::Rc<Vec<String>>, start_index: usize) {
    ...
    counter_label.set_css_classes(&["dim-label"]);
    ...
    // Helper: update displayed image for current index
    let update_view: std::rc::Rc<dyn Fn()> = std::rc::Rc::new({
        ...
        move || {
            ...
            next_btn.set_sensitive(idx + 1 < total);
        }
    });
    ...
    // Open button
    {
        ...
        open_btn.connect_clicked(move |_| {
            let path = &paths[current_index.get()];
